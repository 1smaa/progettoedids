...
public class GameManager {
    ...
    //Room ID at which the correspondent callback should be triggered
    int[] triggers={2,4,5,7,12};
    //Index or phase of the game, to indicate next callback
    int ind=0;
    ...
    //Move in the direction provided, returns 1 if the game has been beaten, 0 for normal activity, -1 for gameover
    public int move(char direction) throws FileNotFoundException {
        ...
        if(this.map.currId()==this.triggers[this.ind]){
            ...
            //If the current index is over the limit of game phases, the game has been beaten and the player won
